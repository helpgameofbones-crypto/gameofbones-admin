            ...
            <div className="mb-4">
              <div className="bg-yellow-50 border border-yellow-200 rounded-xl p-4">
                <p className="text-sm" style={{ color: '#92400e' }}>
                  ⚠️ These products have had <strong>zero sales in the last 30 days</strong>.
                  ...
                  {deadStock.length === 0 ? (
                    ...
                    return (
                      <tr key={product.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3" style={{ color: '#374151' }}>₹{product.price}</td>
                    ...
                    return (
                      <tr key={product.id} className="hover:bg-gray-50">
                        ...
                        <td className="px-4 py-3" style={{ color: '#6b7280' }}>
                          {product.cost_price > 0 ? '₹' + product.cost_price : <span style={{ color: '#9ca3af' }}>Est.</span>}
                        </td>
                        <td className="px-4 py-3" style={{ color: '#374151' }}>₹{product.price}</td>
                        <td className="px-4 py-3 font-medium" style={{ color: '#ef4444' }}>

...
<div style="font-size:13px;color:rgba(26,16,8,0.7);margin-top:4px">Thank you ${order.customer_name?.split(' ')[0] || ''}! Your order is placed.</div>
</div>
<div style="background:white;padding:28px 32px">
<p style="font-size:14px;color:#8a7a6a">Order Reference: <strong style="color:#1a1008">${order.ref}</strong></p>
<p style="font-size:14px;color:#8a7a6a">Payment: <strong style="color:#1a1008">${order.payment_method === 'cod' ? 'Cash on Delivery' : 'Prepaid'}</strong></p>
...
${order.shipping > 0 ? '<p style="font-size:13px;color:#8a7a6a;margin:4px 0">Shipping: Rs.' + order.shipping + '</p>' : '<p style="font-size:13px;color:#16a34a;margin:4px 0">Shipping: FREE</p>'}

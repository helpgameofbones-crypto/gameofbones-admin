...
const CAMPAIGNS = [
  {
    ...
    subject: 'ðŸ¾ Welcome to the Game of Bones family!',
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
        ...
        <div style="background:#f9f6f2;padding:40px 32px;text-align:center">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr 1fr;gap:12px;margin:24px 0;text-align:center">
            ${[
              { emoji: 'ðŸ¦´', title: '100% Natural', desc: 'Zero preservatives' },
              { emoji: 'ðŸ‡®ðŸ‡³', title: 'Made in India', desc: 'Locally sourced' },
              { emoji: 'â¤ï¸', title: 'Vet Approved', desc: 'Safe for all dogs' },
            ].map(f => `
        ...
        <div style="background:#1a1008;padding:24px 32px;text-align:center">
          ...
          <p style="color:rgba(255,255,255,0.4);margin:0;font-size:12px">gameofbones.in Â· WhatsApp: +91 90825 03295</p>
        </div>
      </div>
    `
  },
  {
    ...
    subject: 'ðŸ¾ We miss you (and so does your pup\'s treat jar)!',
    previewText: 'It\'s been a while â€” come back for something special',
    html: (name: string, coupon: string) => `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
        <div style="background:linear-gradient(135deg,#1a1008,#3d2314);padding:40px 32px;text-align:center">
          <div style="font-size:48px;margin-bottom:12px">ðŸ¾</div>
        ...
        <div style="background:#f9f6f2;padding:40px 32px;text-align:center">
          ...
          <p style="color:#6b7280;font-size:15px;line-height:1.7;margin:0 0 24px">
            ...
            We've been busy adding new flavours and sizes â€” come see what's new!
          </p>
          <div style="background:white;border-radius:16px;padding:24px;margin:24px 0;text-align:left">
            <p style="margin:0 0 16px;font-weight:bold;color:#1a1008">ðŸ†• What's new at Game of Bones:</p>
            ${[
              'ðŸŸ New Fish Treats â€” Omega-3 rich sardines and rohu',
              'ðŸ Goat Organ Packs â€” Liver, kidney and heart mix',
              'ðŸ” Larger sizes â€” Now available in 280g and 400g',
          ...
          <div style="background:white;border:2px dashed #ef4444;border-radius:16px;padding:24px;margin:24px 0">
            ...
            <p style="margin:8px 0 0;color:#9ca3af;font-size:12px">15% off â€” valid for 48 hours only!</p>
          </div>` : ''}
  ...
  {
    id: 'flash_sale',
    name: 'Flash Sale â€” 24 Hours Only',
    emoji: 'âš¡',
    color: '#f59e0b',
    bg: '#fefce8',
    description: 'Urgent 24-hour flash sale to drive quick orders',
    subject: 'âš¡ 24-HOUR FLASH SALE â€” Up to 30% off ends tonight!',
    previewText: 'Don\'t miss this â€” sale ends at midnight!',
    html: (name: string, coupon: string) => `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
        ...
        <div style="background:#1a1008;padding:16px;text-align:center">
          <p style="color:#f59e0b;margin:0;font-size:18px;font-weight:bold">
            â° Sale ends at MIDNIGHT tonight
          </p>
        </div>
        <div style="background:#f9f6f2;padding:40px 32px;text-align:center">
          ...
          <p style="color:#6b7280;font-size:15px;line-height:1.7;margin:0 0 32px">
            ...
            Your pup deserves a treat â€” and so does your wallet!
          </p>
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:0 0 32px">
            ${[
              { name: 'Chicken Jerky', original: 'â‚¹329', sale: 'â‚¹249', emoji: 'ðŸ—' },
              { name: 'Fish Treats',   original: 'â‚¹399', sale: 'â‚¹299', emoji: 'ðŸŸ' },
              { name: 'Goat Organs',   original: 'â‚¹449', sale: 'â‚¹329', emoji: 'ðŸ' },
              { name: 'Bone Bundle',   original: 'â‚¹599', sale: 'â‚¹429', emoji: 'ðŸ¦´' },
            ].map(p => `
  ...
  },
  {
    ...
    subject: 'ðŸ¾ Is your pup\'s treat jar running low?',
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
        ...
        <div style="background:#f9f6f2;padding:40px 32px;text-align:center">
          ...
          <p style="color:#6b7280;font-size:15px;line-height:1.7;margin:0 0 24px">
            ...
            Don't let the treat jar go empty â€” happy dogs need happy snacks!
          </p>
          <div style="background:white;border-radius:16px;padding:24px;margin:0 0 24px;text-align:left">
            <p style="margin:0 0 16px;font-weight:bold;color:#1a1008;font-size:15px">ðŸ¦´ Why reorder now?</p>
            ${[
              'âš¡ Fast delivery â€” 4 to 7 business days',
              'ðŸ“¦ Free delivery on orders above Rs 499',
              'ðŸŽ Loyalty points on every order',
              'ðŸ• Your dog will love you for it',
  ...
  },
  {
    ...
    subject: 'ðŸ†• Just launched â€” your dog NEEDS to try this!',
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
        ...
        <div style="background:#f9f6f2;padding:40px 32px;text-align:center">
          ...
          <div style="background:white;border-radius:20px;padding:32px;margin:0 0 24px;text-align:center;border:2px solid #8b5cf6">
            <div style="font-size:64px;margin-bottom:16px">ðŸŸ</div>
            ...
            <div style="font-size:24px;font-weight:900;color:#8b5cf6">Starting at â‚¹299</div>
          </div>
          ${coupon ? `
          <div style="background:white;border:2px dashed #8b5cf6;border-radius:16px;padding:24px;margin:0 0 24px">
            <p style="margin:0 0 8px;color:#6b7280;font-size:13px">Launch offer â€” first 100 orders</p>
  ...
  },
  {
    ...
    subject: 'ðŸ‘‘ You\'re a VIP â€” exclusive offer inside!',
      ...
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
        ...
        <div style="background:#f9f6f2;padding:40px 32px;text-align:center">
          <div style="background:white;border-radius:20px;padding:24px;margin:0 0 24px;border:2px solid #c8973a">
            ...
            <p style="margin:8px 0 0;color:#9ca3af;font-size:12px">One of our most valued customers ðŸ¾</p>
          </div>
          <p style="color:#6b7280;font-size:15px;line-height:1.7;margin:0 0 32px">
            You've been with us from the beginning. You're not just a customer â€”
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:0 0 24px">
            ${[
              { emoji: 'ðŸŽ', title: 'Exclusive Discount', desc: '25% off everything' },
              { emoji: 'ðŸš€', title: 'Priority Dispatch', desc: 'Your order ships first' },
              { emoji: 'ðŸ‘‹', title: 'Early Access', desc: 'New products first' },
              { emoji: 'ðŸ’¬', title: 'Direct Line', desc: 'WhatsApp us anytime' },
            ].map(f => `
          ...
          <div style="background:linear-gradient(135deg,#c8973a,#92400e);border-radius:16px;padding:24px;margin:0 0 24px">
            ...
            <p style="margin:8px 0 0;color:rgba(255,255,255,0.6);font-size:12px">25% off â€” valid for 7 days</p>
          </div>` : ''}
  ...
  },
  {
    ...
    subject: 'ðŸŽ‚ Happy Birthday to your furry best friend!',
    ...
    html: (name: string, coupon: string) => `
      <div style="font-family:Arial,sans-serif;max-width:600px;margin:0 auto;background:#ffffff">
        ...
        <div style="background:#f9f6f2;padding:40px 32px;text-align:center">
          <h2 style="color:#1a1008;margin:0 0 12px;font-size:24px">Hey ${name}! ðŸŽ‰</h2>
          <p style="color:#6b7280;font-size:15px;line-height:1.7;margin:0 0 24px">
            ...
            Game of Bones treats â€” because the goodest dogs deserve the best snacks!
          </p>
          ...
          <div style="background:white;border:2px dashed #ec4899;border-radius:16px;padding:24px;margin:24px 0">
            <p style="margin:0 0 8px;color:#6b7280;font-size:13px">Birthday gift from us ðŸŽ</p>
            <div style="font-size:32px;font-weight:800;color:#ec4899;letter-spacing:4px">${coupon}</div>
            <p style="margin:8px 0 0;color:#9ca3af;font-size:12px">20% off â€” birthday month special</p>
          </div>` : ''}
  ...
  },
  {
    ...
    subject: 'ðŸ¾ Share the love â€” get rewarded for every friend you refer!',
        ...
        <div style="background:#f9f6f2;padding:40px 32px;text-align:center">
          ...
          <div style="display:grid;grid-template-columns:1fr 1fr;gap:12px;margin:0 0 32px">
            <div style="background:white;border-radius:16px;padding:24px;text-align:center;border:2px solid #06b6d4">
              ...
              <div style="color:#06b6d4;font-weight:900;font-size:24px;margin:8px 0">â‚¹100</div>
          ...
          <div style="background:white;border:2px dashed #06b6d4;border-radius:16px;padding:24px;margin:0 0 24px">
            <p style="margin:0 0 8px;color:#6b7280;font-size:13px">Your referral code â€” share this!</p>
...
export default function CampaignsPage() {
  ...
  async function sendCampaign(campaign: any) {
    ...
    if (targetCustomers.length === 0) {
      setMsg('âŒ No customers in this segment')
      return
    }
    ...
    try {
      ...
      setMsg(`âœ… ${campaign.name} sent to ${data.sent || targetCustomers.length} customers!`)
      setSelectedCampaign(null)
      setCouponCode('')
      setCustomSubject('')
    } catch {
      setMsg('âŒ Failed to send campaign')
    }
    setSending(null)
      ...
      <div className="p-6 max-w-7xl mx-auto">
        <div className="mb-6">
          ...
          <p className="text-sm mt-1" style={{ color: '#6b7280' }}>
            Pre-written campaigns with beautiful designs â€” one click to send
          </p>
        </div>
            ...
            <div key={campaign.id} className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
              ...
              <div className="p-4">
                <div className="text-xs mb-3" style={{ color: '#9ca3af' }}>
                  ðŸ“§ {campaign.subject.slice(0, 45)}...
                </div>
          ...
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-screen overflow-y-auto">
            <div className="p-4 border-b border-gray-100 flex items-center justify-between sticky top-0 bg-white">
              <div className="font-bold" style={{ color: '#111827' }}>
                {preview.emoji} {preview.name} â€” Preview
              </div>
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="p-3 rounded-lg" style={{ background: '#f0fdf4', border: '1px solid #bbf7d0' }}>
                <div className="text-xs font-semibold" style={{ color: '#166534' }}>
                  ðŸ“¨ Sending to {getSegmentCustomers(segment).length} customers

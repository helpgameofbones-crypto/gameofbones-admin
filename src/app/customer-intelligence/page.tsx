                ...
                <div className="space-y-1">
                  {[
                    ...
                    <div key={f.field} className="flex items-center gap-2">
                      ...
                      <span className="text-xs" style={{ color: '#9ca3af' }}>— {f.note}</span>
                    </div>
                  ))}
                </div>
                ...
                <div>
                  ...
                  {mergePhone2 && customers.find(c => c.phone === mergePhone2) && (
                    <div className="mt-1 text-xs" style={{ color: '#ef4444' }}>
                      ⚠️ {customers.find(c => c.phone === mergePhone2)?.name} will be deleted
                    </div>
                  )}
                </div>
                <div className="p-3 rounded-lg" style={{ background: '#fef2f2' }}>
                  <p className="text-xs" style={{ color: '#ef4444' }}>
                    ⚠️ This action cannot be undone. The second customer profile will be permanently deleted.
                  </p>
                </div>
              ...
              <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
                ...
                {customers.filter(c => {
                  ...
                  <div key={c.id} className="flex items-center justify-between py-2 border-b border-gray-50">
                    <div>
                      <div className="text-sm font-medium" style={{ color: '#111827' }}>{c.name}</div>
                      <div className="text-xs" style={{ color: '#9ca3af' }}>{c.total_orders} orders · ₹{c.total_spent}</div>
                    </div>

      ...
      <div className="p-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
          {[
            ...
            { label: 'Total Refunded',   value: '₹' + totalRefunded.toLocaleString('en-IN'),  icon: '↩️', color: '#ef4444' },
            ...
            <div className="p-6 space-y-4">
              ...
              <div className="p-3 rounded-lg" style={{ background: '#fef2f2' }}>
                <p className="text-xs" style={{ color: '#ef4444' }}>
                  ⚠️ This will immediately refund ₹{refundAmount} to the customer. This cannot be undone.
                </p>
              </div>

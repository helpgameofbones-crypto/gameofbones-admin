          ...
          <div className="space-y-6">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              {[
                ...
                { label: 'Discounts',      value: '-' + totalDiscount.toLocaleString('en-IN'), icon: '', color: '#f59e0b' },
                { label: 'Refunds',        value: '-' + totalRefunds.toLocaleString('en-IN'),  icon: '', color: '#ef4444' },
        ...
        {tab === 'refunds' && (
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-4 mb-4">
              {[
                { label: 'Total Refunds',   value: orders.filter(o => o.is_refunded).length, icon: '', color: '#ef4444' },

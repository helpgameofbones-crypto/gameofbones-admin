...
const SECTIONS = [
  ...
  { title: 'ORDERS', color: '#f59e0b', items: [
    ...
    { name: 'Duplicate Orders', href: '/duplicate-orders', icon: '🧬', desc: 'Detect likely-duplicate order submissions' },
    { name: 'Returns', href: '/returns', icon: '↩️', desc: 'Track returned orders' },
    { name: 'Refund Rate', href: '/refund-tracker', icon: '📉', desc: 'Refund rate trends over time' },
  ]},
  { title: 'SHIPPING', color: '#8b5cf6', items: [
    ...
    { name: 'Delivery Estimator', href: '/delivery-estimator', icon: '📅', desc: 'Live ETAs pulled from Delhivery tracking, per order' },
    { name: 'Zone Delivery Estimator', href: '/order-timeline', icon: '🗓️', desc: 'Estimated delivery windows by shipping zone/pincode' },
    { name: 'Shipment Tracker', href: '/shipment-tracker', icon: '🚚', desc: 'Track all shipments in one place' },
    { name: 'RTO Risk', href: '/rto', icon: '⚠️', desc: 'Predicted return-to-origin risk by order' },
  ]},
  { title: 'PRODUCTS', color: '#16a34a', items: [
    ...
    { name: 'Production Tracker', href: '/production', icon: '🏭', desc: 'Track batches through production' },
  ]},
  { title: 'CUSTOMERS', color: '#ec4899', items: [
    { name: 'All Customers', href: '/customers', icon: '👥', desc: 'Name, orders, lifetime value, contact info' },
    { name: 'Loyalty Points', href: '/loyalty', icon: '⭐', desc: 'Points balances, manual adjustments, dog profiles' },
    ...
    { name: 'NPS Survey', href: '/nps', icon: '💬', desc: 'Customer satisfaction survey responses' },
    { name: 'Customer Intelligence', href: '/customer-intelligence', icon: '🧠', desc: 'Deeper customer segments and behavior signals' },
  ]},
  { title: 'CONTENT', color: '#06b6d4', items: [
    ...
    { name: 'Banners', href: '/banners', icon: '🚩', desc: 'Site-wide announcement banners' },
  ]},
  { title: 'MARKETING', color: '#f97316', items: [
    ...
    { name: 'Lifecycle Campaigns', href: '/campaigns', icon: '📣', desc: 'Welcome, win-back, and flash-sale email campaigns' },
    { name: 'Festival Campaigns', href: '/campaigns-hub', icon: '🎉', desc: 'Diwali, Holi, and other festival discount campaigns' },
    { name: 'Promotions', href: '/promotions', icon: '🔥', desc: 'Flash sales and product bundles' },
    { name: 'Ad Spend & UTM', href: '/marketing', icon: '📊', desc: 'Ad spend tracking and UTM link builder' },
    { name: 'Gamification', href: '/gamification', icon: '🎮', desc: 'Spin-wheel and reward-game settings' },
  ]},
  { title: 'ANALYTICS', color: '#6366f1', items: [
    { name: 'Overview', href: '/analytics', icon: '📊', desc: 'Revenue trends, conversion rates, AOV' },
    { name: 'Advanced Analytics', href: '/analytics-advanced', icon: '📐', desc: 'Deeper revenue and funnel breakdowns' },
    { name: 'City Heatmap', href: '/city-heatmap', icon: '🗺️', desc: 'Order volume by city and region' },
    { name: 'Cohort Analysis', href: '/cohort-analysis', icon: '📆', desc: 'Retention by signup/order cohort' },
    { name: 'Hour of Day Analysis', href: '/hour-analysis', icon: '🕐', desc: 'Order volume by hour of day' },
    { name: 'Product Affinity', href: '/product-affinity', icon: '🔗', desc: 'Which products get bought together' },
  ]},
  { title: 'FINANCE', color: '#84cc16', items: [
    ...
    { name: 'Bulk Invoices', href: '/bulk-invoices', icon: '📚', desc: 'Download invoices for multiple orders at once' },
    { name: 'Bulk Export', href: '/bulk-export', icon: '📤', desc: 'Export order/customer data in bulk' },
  ]},
  { title: 'OPERATIONS', color: '#78716c', items: [
    ...
    { name: 'Ops Dashboard', href: '/operations', icon: '🗂️', desc: 'General operations overview' },
    { name: 'Notification Center', href: '/notifications', icon: '🔔', desc: 'All system notifications in one place' },
  ]},
];
